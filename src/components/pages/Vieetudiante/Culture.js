      ...
      <div className="fondCulture">
        <div className="textMC">
          ...
          <p>
            ...
            Elle met par exemple des <em title="La valeur totale du carnet est de 32€ avec un prix de vente du carnet est de 16€.">carnets culture</em> qui sont des coupons
            utilisables dans plus de 60 établissements culturels et qui vous
