    ...
    return (
        <div className="choisirBUT">
            <div className="avantagesIUT">
                ...
                -Associations sportives/vie étudiante<br />(maison des étudiants)<br />
                -Du soutien et une forte communication<br /> entre RT1 et RT2<br />
                -Un RestoU (3.30€/repas + qualité car il est relié à l'hôpital)<br /> et un BistroU (Crous) disponible pour les repas du midi.<br />
            ...
            <div className="avantagesBUT">
                ...
                <p className paragavantageBUT>-Formation en 3 ans<br />
